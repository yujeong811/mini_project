		...
		<div class="card">
			...
			<div class="card-body table-responsive p-0">
				<table class="table table-hover text-nowrap">
					<thead>
						<tr style="font-size: 0.95em;" class="info">
					...
					<c:forEach items="${noticeList }" var="notice">
						<tr style='font-size: 0.85em; cursor: pointer;'
							onclick="OpenWindow('detail.do?from=list&nno=${notice.nno }','상세보기',800,700);">
							...
							<td id="boardTitle"
								style="text-align: left; max-width: 100px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"  ${notice.fixed eq 1 ? 'class="red"' : ''}>
								${notice.title }</td>
							<td data-target="notice-writer">${notice.writer}
